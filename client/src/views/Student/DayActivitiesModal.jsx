...
import "../ContentCreator/DayEditor/DayEditor.less"

const DayActivities = ({ thisDay,  viewing, setViewing, learningStandard  }) => {
          ...
          {days.length > 0 ? (
            <div>
              <p id="day-editor-subtitle">
                Choose the <strong>Activity</strong> you wish to work on!
              </p>
              <List
