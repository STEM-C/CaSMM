...
const MentorSandboxMentor = ({ thisDay, viewing, setViewing, learningStandard  }) => {
  ...
  const handleViewActivityTemplate = async (day, index) => {
    ...
    localStorage.setItem("my-day", JSON.stringify(day))
    localStorage.setItem("multi_number", parseInt(index) )
    openActivityInWorkspace(day, learningStandard.name)
...
export default MentorSandboxMentor
