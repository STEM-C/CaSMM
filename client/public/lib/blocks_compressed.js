...
Blockly.Blocks.procedures_defreturn = {
  ...
  getReturnType: function () {
    ...
    b &&
      (a = b.getBlockType
        ? b.getBlockType()
        : Blockly.Types.getChildBlockType(b));
    return a;
  },
};
...
Blockly.Blocks.procedures_callnoreturn = {
  init: function () {
    this.appendDummyInput('TOPROW').appendField(
      new Blockly.FieldTextInput(Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE),
      'NAME'
    );
    this.setPreviousStatement(!0);
    this.setNextStatement(!0);
...
Blockly.Blocks.procedures_callreturn = {
  ...
  getBlockType: function () {
    return Blockly.Procedures.getDefinition(
      this.getProcedureCall(),
      this.workspace
    ).getReturnType();
  },
...
Blockly.Blocks.text_getSubstring = {
  ...
  updateAt_: function (a, b) {
    ...
    b
      ? (this.appendValueInput('AT' + a).setCheck(
...
Blockly.Blocks.text_prompt_ext = {
  init: function () {
    ...
    this.setOutput(!0, Blockly.Types.TEXT.output);
    this.setTooltip(function () {
      return b.getFieldValue('TYPE') == Blockly.Types.TEXT.output
  ...
  updateType_: function (a) {
    this.outputConnection.setCheck(
      a == Blockly.Types.NUMBER.output
        ? Blockly.Types.NUMBER.checkList
        : Blockly.Types.TEXT.checkList
    );
  },
  mutationToDom: function () {
    var a = document.createElement('mutation');
...
Blockly.Blocks.math_number_property = {
  init: function () {
    ...
    a = new Blockly.FieldDropdown(a, function (b) {
      this.sourceBlock_.updateShape_('DIVISIBLE_BY' == b);
    });
...
Blockly.Blocks.spi_transfer = {
  init: function () {
    var a = [[Blockly.Msg.ARD_SPI_TRANS_NONE, 'none']].concat(
    ...
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(a), 'SPI_SS');
    this.setInputsInline(!0);
  ...
  onchange: function (a) {
    if (
      this.workspace &&
      a.type != Blockly.Events.MOVE &&
      a.type != Blockly.Events.UI
    ) {
      a = this.getFieldValue('SPI_ID');
      for (
        var b = Blockly.mainWorkspace.getTopBlocks(),
          c = !1,
          d = 0,
          e = b.length;
        d < e;
      ...
      c
        ...
        : this.setWarningText(
            Blockly.Msg.ARD_SPI_TRANS_WARN1.replace('%1', a),
            'spi_setup'
          );
    }
  },
  ...
  updateFields: function () {
    var a = this.getField('SPI_SS'),
      b = a.getValue();
    a.menuGenerator_ = [[Blockly.Msg.ARD_SPI_TRANS_NONE, 'none']].concat(
      Blockly.Arduino.Boards.selected.digitalPins
    );
    for (var c = !1, d = 0, e = a.menuGenerator_.length; d < e; d++)
      b == a.menuGenerator_[d][1] && (c = !0);
    c
      ? this.setWarningText(null, 'bPin')
      : this.setWarningText(
          Blockly.Msg.ARD_SPI_TRANS_WARN2.replace('%1', b),
          'bPin'
        );
  },
};
Blockly.Blocks.spi_transfer_return = {
  init: function () {
    ...
    this.appendValueInput('SPI_DATA').appendField(
...
Blockly.Blocks.block_comment = {
  init: function () {
    this.appendDummyInput()
      .appendField('/*')
      .appendField(
        new Blockly.FieldTextInput('Block comment'),
        'comment_input'
      );
    this.appendStatementInput('comment').setCheck(null).appendField('*/');
    this.setPreviousStatement(!0, null);
    this.setNextStatement(!0, null);
    this.setColour(Blockly.Blocks.texts.HUE);
    this.setTooltip(Blockly.Msg.BLOCK_COMMENT_TIP);
    this.setHelpUrl(
      'https://www.arduino.cc/reference/tr/language/structure/further-syntax/blockcomment/'
    );
  },
};
...
Blockly.Blocks.serial_setup = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.serial),
        'SERIAL_ID'
      )
      .appendField(Blockly.Msg.ARD_SERIAL_SPEED)
      .appendField(
        new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.serialSpeed),
        'SPEED'
      )
...
Blockly.Blocks.serial_print = {
  ...
  onchange: function (a) {
    if (
      ...
      for (
        var b = Blockly.mainWorkspace.getTopBlocks(), c = !1, d = 0;
        d < b.length;
        d++
      ) {
      ...
      c
        ...
        : this.setWarningText(
            Blockly.Msg.ARD_SERIAL_PRINT_WARN.replace('%1', a),
            'serial_setup'
          );
    }
  },
...
Blockly.Blocks.stepper_config = {
  init: function () {
    var a = new Blockly.FieldDropdown(
      ...
      function (b) {
        this.sourceBlock_.updateShape_('FOUR' == b);
      }
    );
    ...
    this.appendDummyInput('PINS_DROPDOWN')
      ...
      .appendField(a, 'STEPPER_NUMBER_OF_PINS');
...
Blockly.Blocks.stepper_step = {
  init: function () {
    ...
    this.appendValueInput('STEPPER_STEPS').setCheck(
      Blockly.Types.NUMBER.checkList
    );
  ...
  onchange: function (a) {
    this.workspace &&
      a.type != Blockly.Events.MOVE &&
      a.type != Blockly.Events.UI &&
      ((a = this.getFieldValue('STEPPER_NAME')),
      Blockly.Instances.isInstancePresent(a, 'Stepper', this)
        ? this.setWarningText(null)
        : this.setWarningText(
