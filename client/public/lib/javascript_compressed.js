...
Blockly.JavaScript.colour_random = function (a) {
  return [
    Blockly.JavaScript.provideFunction_('colour_random', [
...
Blockly.JavaScript.colour_rgb = function (a) {
  ...
  a =
    ...
    0;
  return [
    Blockly.JavaScript.provideFunction_('colour_rgb', [
      'function ' +
...
Blockly.JavaScript.colour_blend = function (a) {
  ...
  return [
    Blockly.JavaScript.provideFunction_('colour_blend', [
      'function ' +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        '(c1, c2, ratio) {',
...
Blockly.JavaScript.lists_repeat = function (a) {
  var b = Blockly.JavaScript.provideFunction_('lists_repeat', [
      'function ' +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        '(value, n) {',
      '  var array = [];',
...
Blockly.JavaScript.lists_getIndex = function (a) {
  ...
  if ('FIRST' == c) {
    ...
    if ('GET_REMOVE' == b)
      return [a + '.shift()', Blockly.JavaScript.ORDER_MEMBER];
    if ('REMOVE' == b) return a + '.shift();\n';
  } else if ('LAST' == c) {
    if ('GET' == b)
      return [a + '.slice(-1)[0]', Blockly.JavaScript.ORDER_MEMBER];
    if ('GET_REMOVE' == b)
      return [a + '.pop()', Blockly.JavaScript.ORDER_MEMBER];
    ...
    if ('GET_REMOVE' == b || 'REMOVE' == b) {
      c = Blockly.JavaScript.provideFunction_('lists_remove_from_end', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(list, x) {',
        '  x = list.length - x;',
    ...
    c = Blockly.JavaScript.provideFunction_('lists_get_random_item', [
      'function ' +
        Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
        '(list, remove) {',
...
Blockly.JavaScript.lists_setIndex = function (a) {
  ...
  var c =
    ...
    f =
      Blockly.JavaScript.valueToCode(a, 'AT', Blockly.JavaScript.ORDER_NONE) ||
      '1';
  a =
    Blockly.JavaScript.valueToCode(
      a,
  ...
  if ('FIRST' == e) {
    ...
    e = b();
    if ('SET' == d)
      return e + (c + '[' + c + '.length - ' + f + '] = ' + a + ';\n');
    if ('INSERT' == d)
      return e + (c + '.splice(' + c + '.length - ' + f + ', 0, ' + a + ');\n');
  } else if ('RANDOM' == e) {
    e = b();
    f = Blockly.JavaScript.variableDB_.getDistinctName(
      'tmp_x',
      Blockly.Variables.NAME_TYPE
    );
...
Blockly.JavaScript.lists_getSublist = function (a) {
  var b =
    ...
    e =
      Blockly.JavaScript.valueToCode(a, 'AT1', Blockly.JavaScript.ORDER_NONE) ||
      '1';
  a =
    Blockly.JavaScript.valueToCode(a, 'AT2', Blockly.JavaScript.ORDER_NONE) ||
    '1';
  return [
    'FIRST' == c && 'LAST' == d
      ? b + '.concat()'
      : Blockly.JavaScript.provideFunction_('lists_get_sublist', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.JavaScript.lists_sort = function (a) {
  ...
  var d = Blockly.JavaScript.provideFunction_('lists_get_sort_compare', [
    'function ' +
      Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
      '(type, direction) {',
    '  var compareFuncs = {',
...
Blockly.JavaScript.math_number_property = function (a) {
  ...
  if ('PRIME' == c)
    return [
      Blockly.JavaScript.provideFunction_('math_isPrime', [
...
Blockly.JavaScript.math_on_list = function (a) {
  ...
  switch (b) {
    ...
    case 'AVERAGE':
      ...
      break;
    case 'MEDIAN':
      b = Blockly.JavaScript.provideFunction_('math_median', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(myList) {',
      ...
      break;
    case 'MODE':
      b = Blockly.JavaScript.provideFunction_('math_modes', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(values) {',
        '  var modes = [];',
      ...
      break;
    case 'STD_DEV':
      b = Blockly.JavaScript.provideFunction_('math_standard_deviation', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(numbers) {',
      ...
      break;
    case 'RANDOM':
      b = Blockly.JavaScript.provideFunction_('math_random_list', [
        'function ' +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          '(list) {',
        '  var x = Math.floor(Math.random() * list.length);',
...
Blockly.JavaScript.math_random_int = function (a) {
  ...
  a =
    ...
    '0';
  return [
    Blockly.JavaScript.provideFunction_('math_random_int', [
...
Blockly.JavaScript.text_charAt = function (a) {
  ...
  switch (b) {
    ...
    case 'RANDOM':
      return [
        Blockly.JavaScript.provideFunction_('text_random_letter', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            '(text) {',
...
Blockly.JavaScript.text_getSubstring = function (a) {
  ...
  return [
    'FIRST' == c && 'LAST' == d
      ? b
      : Blockly.JavaScript.provideFunction_('text_get_substring', [
          'function ' +
            Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.JavaScript.text_changeCase = function (a) {
  ...
  b
    ? ((a =
      ...
      (a += b))
    : ((b = Blockly.JavaScript.provideFunction_('text_toTitleCase', [
...
Blockly.Arduino['liquidcrystal_clear'] = function (block) {
  var lcdName =
    Blockly.Arduino.valueToCode(
      ...
      'LCD_NAME',
      Blockly.Arduino.ORDER_ATOMIC
    ) || Blockly.Msg.ARD_LIQUIDCRYSTAL_DEFAULT_NAME;
